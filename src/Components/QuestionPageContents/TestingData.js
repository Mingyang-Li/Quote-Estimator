const TestingData = [
  ...
  //   userResponse: [
  //     { optionText: "FB sign up", price: 1500 },
  //     { optionText: "2-factor authentication", price: 1500 },
  //   ],
  // },
  // {
  //   questionIndex: 5,
  ...
  //   userResponse: [
  //     { optionText: "File Uploading", price: 1200 },
  //     { optionText: "Global Search", price: 2000 },
  //     { optionText: "Advanced Filters & Search", price: 2500 },
  //   ],
  // },
  // {
  //   questionIndex: 6,
  ...
  //   userResponse: [
  //     { optionText: "Stripe (Credit Card)", price: 1700 },
  //     { optionText: "Paymark", price: 1400 },
  //   ],
  // },
];
